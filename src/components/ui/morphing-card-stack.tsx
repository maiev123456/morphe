                ...
                >
                  <div className="flex items-start gap-3">
                    {card.icon && (
                      <div
                        className={cn(
                          "flex shrink-0 rounded-lg text-foreground",
                          card.iconFill
                            ? "h-10 w-10 overflow-hidden p-0 bg-transparent [&>img]:block [&>img]:h-full [&>img]:w-full [&>img]:object-contain"
                            : "h-10 w-10 items-center justify-center bg-secondary",
                        )}
                      >
                        {card.icon}
                      </div>
